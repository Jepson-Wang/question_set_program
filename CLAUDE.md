...
Backend code lives under `backend/`. There is no frontend in the repository: the original Vue 3 + Vite client was removed and will be rewritten in React. Check git history if you need to see what it did.
